...
public class OperationNode implements ConditionExecutionCompleteListener, ExecutionNode {
    ...
    public void onConditionExecComplete1(long conditionId, boolean result, Event event) {
        if (nodeResult == null) {
            nodeResult = result;
            this.event = event;
        } else
    ...
    public void onConditionExecComplete(long conditionId, boolean result, Event event) {
        if (nodeResult == null) {
            nodeResult = result;
            this.event = event;
