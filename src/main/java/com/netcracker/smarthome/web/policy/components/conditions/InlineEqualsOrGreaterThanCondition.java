...
public class InlineEqualsOrGreaterThanCondition extends EqualsOrGreaterThanCondition {
    public InlineEqualsOrGreaterThanCondition(Map<String, String> params) {
        super(params);
    }
